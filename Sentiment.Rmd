...
temptable<-xtable(cbind(single_d_debate$text[15:17], single_d_debate$afinn_sentiment[15:17], single_d_debate$bing_sentiment[15:17]))
colnames(temptable) <- c("text", "afinn", "bing")
