...
ggplot(d_all_f %>% filter(name == "CLINTON"), aes(x = afinn_sentiment, y = 2*bing_sentiment)) + geom_jitter(pch=21, width=2, height=2, alpha=.4, fill = "darkred") + geom_smooth(formula = y ~ x) + ggtitle("afinn versus 2*bing sentiment")
