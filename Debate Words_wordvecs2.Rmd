---
title: "WORD VECTORS AND PRESIDENTIAL DEBATES IN R"
author: "WW44SS"
date: "April 5, 2016"
output: 
    html_document:
...
Word vectors, which rely on deep-learning based word-correlation analysis of texts with ~ billions of words, are well known to provide interesting linear structures in the word-vector space. The intention here is to explore these in relation to detecting bias and differences in political speech. 
...
Training word-vectors typically relies on corpora of ~billions of words, far more than the ~100,000 words spoken in the Debates. Hence rather than train the word vectors on the debate text, we'll rely on the "pre-trained" __GloVe__ vectors from [Jeffrey Pennington, Richard Socher, and Christopher D. Manning. 2014](http://nlp.stanford.edu/pubs/glove.pdf) and use them as a basis for analysis.
